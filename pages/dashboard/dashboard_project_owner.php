<?php session_start(); ?>
	<section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><span href="#"><i class="fa fa-dashboard"></i> Level</span></li>
            ...
            <div class="box-body box-profile">
              ...
              <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <b>Center Established</b> <span class="pull-right">
										...
										$result = $mysqli->query("select * from center where ((open_date != '0000-00-00 00:00:00') and (project_owner = ".$_SESSION['id']."))");

										$establish = $result->num_rows;
								...
								<li class="list-group-item">
                  <b>Center Handled</b> <span class="pull-right">
										<?php


												$result = $mysqli->query("select * from center where project_owner = ".$_SESSION['id']);
