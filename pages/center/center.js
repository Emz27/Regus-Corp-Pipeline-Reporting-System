$(document).ready( function ()
    {
      ...
      $('#table_agreement_type').DataTable({
        ...
        "pageLength": 10,
        "ajax": {
          "url": "datatable/agreement_type/data.php",
          "type": "POST"
        },
        "columns": [
        { "data": "urutan" },
    ...
    $(document).on( "click",".agreement_type_btnhapus", function() {
      ...
      swal({
        ...
        function(){
          ...
          $.ajax(
          {
            url : "datatable/agreement_type/delete.php",
            type: "POST",
            data : value,
    ...
    $(document).on("click",".agreement_type_btnedit",function(){
      ...
      $.ajax(
      {
        url : "datatable/agreement_type/fetch.php",
        type: "POST",
        data : value,
        success: function(data, textStatus, jqXHR)
        {
    ...
    $("#inputForm").validate({
      ...
      submitHandler:function(form){
          $.ajax(
          {
            url : "datatable/agreement_type/save.php",
            type: "POST",
