<?php
    ...
    (SELECT @rownum := 0) r");*/
		...
		$query= mysqli_query($link,"SELECT @rownum := @rownum + 1 AS urutan,u.id,u.employee_id,concat(u.street_address,',',c.description,',',+r.description) as address , type.description as user_type, firstname,lastname,gender,birth_date,email,username,cellphone_number,telephone_number,status
