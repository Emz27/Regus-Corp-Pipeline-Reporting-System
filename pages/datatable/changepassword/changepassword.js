$(document).ready( function ()
    {
      $('#table_user').DataTable({
        ...
        "pageLength": 10,
        "ajax": {
          "url": "pages/datatable/changepassword/data.php",
          "type": "POST"
        },
        "columns": [
        { "data": "urutan" },
    ...
    $(document).on( "click",".btnhapus", function() {
      ...
      swal({
        ...
        function(){
          ...
          $.ajax(
          {
            url : "pages/datatable/changepassword/delete.php",
            type: "POST",
            data : value,
    ...
    $(document).on("click",".btnedit",function(){
      ...
      $.ajax(
      {
        url : "pages/datatable/changepassword/fetch.php",
        type: "POST",
        data : value,
        success: function(data, textStatus, jqXHR)
        {
          var data = jQuery.parseJSON(data);
			...
			$("#numberAddress").val(data.address);
    ...
    $("#inputForm").validate({
      ...
      submitHandler:function(form){
        // alert("hello");
          $.ajax(
          {
            url : "pages/datatable/changepassword/save.php",
            type: "POST",
            data : $(form).serialize(),
            success: function(data, textStatus, jqXHR)
            {
